package com.furkqn.music.discord
...
import com.furkqn.music.discord.DiscordDefaults.DISCORD_OAUTH_AUTHORIZE
import com.furkqn.music.discord.DiscordDefaults.DISCORD_OAUTH_TOKEN
import com.furkqn.music.discord.DiscordDefaults.DISCORD_SCOPES
...
class DiscordAuth(
    ...
    companion object {
        ...
        const val REDIRECT_URI = "musicdiscord://oauth2/callback"

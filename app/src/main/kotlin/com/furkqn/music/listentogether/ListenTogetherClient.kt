...
package com.furkqn.music.listentogether
...
import com.furkqn.music.constants.ListenTogetherAutoApprovalKey
import com.furkqn.music.constants.ListenTogetherAutoApproveSuggestionsKey
import com.furkqn.music.constants.ListenTogetherIsHostKey
import com.furkqn.music.constants.ListenTogetherRoomCodeKey
import com.furkqn.music.constants.ListenTogetherServerUrlKey
import com.furkqn.music.constants.ListenTogetherSessionTimestampKey
import com.furkqn.music.constants.ListenTogetherSessionTokenKey
import com.furkqn.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient
    ...
    constructor(
        ...
        companion object {
            ...
            const val ACTION_APPROVE_JOIN = "com.furkqn.music.LISTEN_TOGETHER_APPROVE_JOIN"
            const val ACTION_REJECT_JOIN = "com.furkqn.music.LISTEN_TOGETHER_REJECT_JOIN"
            const val ACTION_APPROVE_SUGGESTION = "com.furkqn.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
            const val ACTION_REJECT_SUGGESTION = "com.furkqn.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
        ...
        private fun loadBlockedUsernames() {
            try {
                val blockedJson = context.dataStore.get(com.furkqn.music.constants.ListenTogetherBlockedUsersKey, "")
                val blockedList =
        ...
        private suspend fun saveBlockedUsernames() {
            try {
                ...
                context.safeDataStoreEdit { preferences ->
                    preferences[com.furkqn.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
                }
            } catch (e: Exception) {

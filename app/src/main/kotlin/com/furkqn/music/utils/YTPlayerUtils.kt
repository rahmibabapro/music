...
import com.furkqn.music.innertube.NewPipeExtractor
import com.furkqn.music.innertube.YouTube
import com.furkqn.music.innertube.models.YouTubeClient
import com.furkqn.music.innertube.models.YouTubeClient.Companion.ANDROID_CREATOR
import com.furkqn.music.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_43_32
import com.furkqn.music.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_61_48
import com.furkqn.music.innertube.models.YouTubeClient.Companion.ANDROID_VR_NO_AUTH
import com.furkqn.music.innertube.models.YouTubeClient.Companion.IOS
import com.furkqn.music.innertube.models.YouTubeClient.Companion.IPADOS
import com.furkqn.music.innertube.models.YouTubeClient.Companion.MOBILE
import com.furkqn.music.innertube.models.YouTubeClient.Companion.TVHTML5
import com.furkqn.music.innertube.models.YouTubeClient.Companion.TVHTML5_SIMPLY_EMBEDDED_PLAYER
import com.furkqn.music.innertube.models.YouTubeClient.Companion.VISIONOS
import com.furkqn.music.innertube.models.YouTubeClient.Companion.WEB
import com.furkqn.music.innertube.models.YouTubeClient.Companion.WEB_CREATOR
...
import com.furkqn.music.utils.YTPlayerUtils.MAIN_CLIENT
import com.furkqn.music.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import com.furkqn.music.utils.YTPlayerUtils.validateStatus
import com.furkqn.music.utils.cipher.CipherDeobfuscator
import com.furkqn.music.utils.cipher.FunctionNameExtractor
import com.furkqn.music.utils.cipher.PlayerJsFetcher
import com.furkqn.music.utils.potoken.PoTokenGenerator
import com.furkqn.music.utils.potoken.PoTokenResult
...
object YTPlayerUtils {
    ...
    suspend fun playerResponseForPlayback(
        ...
        if (streamPlayerResponse.playabilityStatus.status != "OK") {
            ...
            // unavailable streams; Music cannot recover those without official playback.

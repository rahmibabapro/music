...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/furkqn/Music"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "Music.apk" -> "universal" to "foss"
                name == "Music-with-Google-Cast.apk" -> "universal" to "gms"

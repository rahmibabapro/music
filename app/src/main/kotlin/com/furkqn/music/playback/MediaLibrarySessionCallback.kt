...
import com.furkqn.music.constants.AndroidAutoSectionsOrderKey
import com.furkqn.music.constants.AndroidAutoYouTubePlaylistsKey
import com.furkqn.music.ui.screens.settings.AndroidAutoSection
import com.furkqn.music.ui.screens.settings.deserializeSections
import com.furkqn.music.ui.screens.settings.serializeSections
                ...
                when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.furkqn.music.innertube.pages.HomePage.Section>()

...
import com.furkqn.music.constants.AlbumViewTypeKey
...
import com.furkqn.music.constants.MixSortDescendingKey
import com.furkqn.music.constants.MixSortType
import com.furkqn.music.constants.MixSortTypeKey
...
import com.furkqn.music.ui.component.AlbumListItem
import com.furkqn.music.ui.component.ArtistGridItem
import com.furkqn.music.ui.component.ArtistListItem
...
import com.furkqn.music.ui.component.ListItemStyle
...
import com.furkqn.music.ui.menu.PlaylistMenu
...
import com.furkqn.music.viewmodels.LibraryMixViewModel
...
fun LibraryMixScreen(
    ...
    val spotifyListStyle = ListItemStyle.SPOTIFY_LIBRARY
    ...
    if (showLikedPlaylist) {
        allItems = allItems + likedPlaylist
    }
            ...
            LibraryViewType.LIST -> {
                LazyColumn(
                    ...
                    items(
                        ...
                        when (item) {
                            is Playlist -> {
                                val isLikedAuto = item.isLikedAutoPlaylist()
                                PlaylistListItem(
                                    playlist = item,
                                    autoPlaylist = isLikedAuto,
                                    style = spotifyListStyle,
                                    trailingContent = {
                                        if (!isLikedAuto) {
                                            IconButton(
                                                onClick = {
                                    ...
                                    modifier =
                                        Modifier
                                            ...
                                            .combinedClickable(
                                                ...
                                                onLongClick = {
                                                    if (isLikedAuto) return@combinedClickable
                    ...
                    if (filteredItems.isEmpty() && !showLikedPlaylist && searchQuery.isNotBlank()) {

...
fun <E> ChipsRow(
    ...
    val selectedContainer = if (MaterialTheme.colorScheme.background.luminance() < 0.5f) {
        Color.White
    } else {
        MaterialTheme.colorScheme.onSurface
    }
    val selectedLabel = if (MaterialTheme.colorScheme.background.luminance() < 0.5f) {
        Color.Black
    } else {
        MaterialTheme.colorScheme.surface
    }
    val unselectedContainer = MaterialTheme.colorScheme.surfaceContainerHighest

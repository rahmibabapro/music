...
import com.furkqn.music.constants.ContentCountryKey
import com.furkqn.music.constants.ContentLanguageKey
import com.furkqn.music.constants.CountryCodeToName
import com.furkqn.music.constants.EnableBetterLyricsKey
import com.furkqn.music.constants.EnableKugouKey
import com.furkqn.music.constants.EnableLrcLibKey
import com.furkqn.music.constants.EnablePaxsenixKey
import com.furkqn.music.constants.EnableLyricsPlus
...
import com.furkqn.music.constants.LanguageCodeToName
import com.furkqn.music.constants.LyricsProviderOrderKey
import com.furkqn.music.constants.ProxyEnabledKey
import com.furkqn.music.constants.ProxyPasswordKey
import com.furkqn.music.constants.ProxyTypeKey
import com.furkqn.music.constants.ProxyUrlKey
import com.furkqn.music.constants.ProxyUsernameKey
import com.furkqn.music.constants.QuickPicks
import com.furkqn.music.constants.QuickPicksKey
import com.furkqn.music.constants.RandomizeHomeOrderKey
import com.furkqn.music.constants.SYSTEM_DEFAULT
import com.furkqn.music.constants.ShowArtistDescriptionKey
import com.furkqn.music.constants.ShowMostStatsPlaylistsKey
import com.furkqn.music.constants.ShowArtistSubscriberCountKey
import com.furkqn.music.constants.ShowMonthlyListenersKey
import com.furkqn.music.constants.ShowWrappedCardKey
import com.furkqn.music.constants.TopSize
...
import com.furkqn.music.ui.component.DraggableLyricsProviderItem
import com.furkqn.music.ui.component.DraggableLyricsProviderList
...
fun ContentSettings(
    ...
    val (showMostStatsPlaylists, onShowMostStatsPlaylistsChange) =
        rememberPreference(key = ShowMostStatsPlaylistsKey, defaultValue = false)
    ...
    LaunchedEffect(showMostStatsPlaylists) {
        if (!showMostStatsPlaylists) {
            database.withTransaction {
                clearPlaylist(com.furkqn.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID)
                clearPlaylist(com.furkqn.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID)
                delete(
                    com.furkqn.music.db.entities.PlaylistEntity(
                        id = com.furkqn.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
                delete(
                    com.furkqn.music.db.entities.PlaylistEntity(
                        id = com.furkqn.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
            }

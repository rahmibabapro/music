package com.furkqn.music.paxsenix

import android.content.Context
import com.furkqn.music.betterlyrics.TTMLParser
import com.furkqn.music.paxsenix.models.AppleMusicSearchResponse
import com.furkqn.music.paxsenix.models.LyricsResponse

import com.furkqn.music.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(CIO) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "Music/$appVersion")
                }

# Working with Music as an AI agent

Music is a 3rd party YouTube Music client written in Kotlin. It follows material 3 design guidelines closely.
...
3. All string edits should be made to the `Music/app/src/main/res/values/music_strings.xml` file, NOT `Music/app/src/main/res/values/strings.xml`. Do not touch other `strings.xml` or `music_strings.xml` files in the project. ONLY edit the default (English) `music_strings.xml` file, DO NOT EDIT OTHER LANGUAGES.
